...
```env
LOCAL_API_URL=http://188.166.212.251:4281
API_ID=your_api_id
...
server {
    ...
    location / {
        proxy_pass http://188.166.212.251:4281;
...
🌐 Web Dashboard:
   Local:   http://188.166.212.251:4281
   Network: http://188.166.212.251:4281
```
...
1. Buka `http://188.166.212.251:4281`
...
**ApongSakata** - [@ApongSakata](https://t.me/ApongSakata)
